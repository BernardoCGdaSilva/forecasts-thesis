...
myTimeControl <- trainControl(method = "timeslice",
                              ...
                              returnResamp='all') # Este argumento armazena as samples da validação cruzada

tuneLength.num <- 15 # para o ajuste de parâmetros, peço para o modelo testar cinco alternativas para cada parâmetro.
...
modelos <- resamples(list("Linear Regression" = model_lm,
